...
public class EbayHomepageActions {
	...
	*/
	...
	public void searchFromExcel() throws Exception{
		String xlData = ReadExcelSheet.getMapData("Skywalker");
		System.out.println("Data from Excel file >>>>>>>>>> "+ xlData);
		
		EbayHomepageLocatorsObj.txtbxSearch.sendKeys(xlData);							//Write on Search Textbox
		EbayHomepageLocatorsObj.btnSearch.click();										//Click on the Search Button
	}
